...
//For 4e:
  ...
  TString meanformula_up = "@0*(1+0.003)";
  TString meanformula_dn = "@0*(1-0.003)";
  if(chan=="4mu"){
	meanformula_up = "@0*(1+0.001)";
	meanformula_dn = "@0*(1-0.001)";
  }
  else if(chan=="2e2mu"){
	meanformula_up = "@0*(1+0.0015)";
	meanformula_dn = "@0*(1-0.0015)";
  }

  RooFormulaVar* mean_p0_up = new RooFormulaVar("mean_p0_up","", meanformula_up.Data(), *mean_p0_2nd);
  RooFormulaVar* mean_p0_dn = new RooFormulaVar("mean_p0_dn","", meanformula_dn.Data(), *mean_p0_2nd);
  ...
  RooDoubleCB dcrReso(Form("dcrReso_%s_iCat%d_%djet",chan.Data(), iCat, cate_vbf), "Double Crystal ball ", *mreco, *mean_p0_2nd, *sigma_p0_2nd, *a1_p0_2nd, *n1_p0_2nd, *a2_p0_2nd, *n2_p0_2nd);
  RooDoubleCB dcrReso_up(Form("dcrReso_%s_iCat%d_%djet_up",chan.Data(), iCat, cate_vbf), "dcb up", *mreco, *mean_p0_2nd, *sigma_p0_up, *a1_p0_2nd, *n1_p0_2nd, *a2_p0_2nd, *n2_p0_2nd);
  RooDoubleCB dcrReso_dn(Form("dcrReso_%s_iCat%d_%djet_dn",chan.Data(),iCat, cate_vbf), "dcb dn", *mreco, *mean_p0_2nd, *sigma_p0_dn, *a1_p0_2nd, *n1_p0_2nd, *a2_p0_2nd, *n2_p0_2nd);
  RooDoubleCB dcrScale_up(Form("dcrScale_%s_iCat%d_%djet_up",chan.Data(), iCat, cate_vbf), "dcb Scale up", *mreco, *mean_p0_up, *sigma_p0_2nd, *a1_p0_2nd, *n1_p0_2nd, *a2_p0_2nd, *n2_p0_2nd);
  RooDoubleCB dcrScale_dn(Form("dcrScale_%s_iCat%d_%djet_dn",chan.Data(),iCat, cate_vbf), "dcb Scale dn", *mreco, *mean_p0_dn, *sigma_p0_2nd, *a1_p0_2nd, *n1_p0_2nd, *a2_p0_2nd, *n2_p0_2nd);
...
//	convpdf_spline.plotOn(frame);
	...
	Width_conv convpdf_spline_up("VH_ResUp", "VH_Res"+chan+"Up",*mreco, *mean, *sigma, *r, RooArgList(pdf_x, pdf_ggzz,dcrReso_up),*cosfunc, *sinfunc, *effxkf_sig,*effxkf_bkg); 
	Width_conv convpdf_spline_dn("VH_ResDown", "VH_Res"+chan+"Down",*mreco, *mean, *sigma, *r, RooArgList(pdf_x, pdf_ggzz,dcrReso_dn),*cosfunc, *sinfunc, *effxkf_sig,*effxkf_bkg); 
	Width_conv convpdf_spline_mean_up("VH_ScaleUp", "VH_Scale"+chan+"Up",*mreco, *mean, *sigma, *r, RooArgList(pdf_x, pdf_ggzz,dcrScale_up),*cosfunc, *sinfunc, *effxkf_sig,*effxkf_bkg);
        Width_conv convpdf_spline_mean_dn("VH_ScaleDown", "VH_Scale"+chan+"Down",*mreco, *mean, *sigma, *r, RooArgList(pdf_x, pdf_ggzz,dcrScale_dn),*cosfunc, *sinfunc, *effxkf_sig,*effxkf_bkg);

	w.import(convpdf_spline_up,RecycleConflictNodes());
	w.import(convpdf_spline_dn,RecycleConflictNodes());
	w.import(convpdf_spline_mean_up,RecycleConflictNodes());
        w.import(convpdf_spline_mean_dn,RecycleConflictNodes());
