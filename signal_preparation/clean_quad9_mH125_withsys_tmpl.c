...
//For 4e:
  ...
  RooDoubleCB dcrmean_up(Form("dcrMean_%s_iCat%d_%djet_up",chan.Data(),iCat, cate_vbf), "dcb mean up", *mreco, *mean_p0_up, *sigma_p0_2nd, *a1_p0_2nd, *n1_p0_2nd, *a2_p0_2nd, *n2_p0_2nd);
  RooDoubleCB dcrmean_dn(Form("dcrMean_%s_iCat%d_%djet_dn",chan.Data(),iCat, cate_vbf), "dcb mean dn", *mreco, *mean_p0_dn, *sigma_p0_2nd, *a1_p0_2nd, *n1_p0_2nd, *a2_p0_2nd, *n2_p0_2nd);
...
//To account for 2mu systematics, not really implemented
    if(chan=="2e2mu"){
	RooFormulaVar* mean_p0_up = new RooFormulaVar("mean_p0_up","", "@0*(1+0.0005)", *mean_p0_2nd);
	RooFormulaVar* mean_p0_dn = new RooFormulaVar("mean_p0_dn","", "@0*(1-0.0005)", *mean_p0_2nd);
  	RooDoubleCB dcrmean_up(Form("dcrMean_%s_iCat%d_%djet_up",chan.Data(),iCat, cate_vbf), "dcb mean up", *mreco, *mean, *mean_p0_up, *sigma_p0_2nd, *a1_p0_2nd, *n1_p0_2nd, *a2_p0_2nd, *n2_p0_2nd);
  	RooDoubleCB dcrmean_dn(Form("dcrMean_%s_iCat%d_%djet_dn",chan.Data(),iCat, cate_vbf), "dcb mean dn", *mreco, *mean, *mean_p0_dn, *sigma_p0_2nd, *a1_p0_2nd, *n1_p0_2nd, *a2_p0_2nd, *n2_p0_2nd);
