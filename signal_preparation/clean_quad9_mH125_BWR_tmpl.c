...
std::cout<<"***********************************"<<endl;
  ...
  RooDoubleCBFast dcrReso(Form("dcrReso_%s_iCat%d_%djet",chan.Data(), iCat, cate_vbf), "Double Crystal ball ", *x, *mean_p0_2nd, *sigma_p0_2nd, *a1_p0_2nd, *n1_p0_2nd, *a2_p0_2nd, *n2_p0_2nd);
  ...
  RooBreitWigner* brpdf = new RooBreitWigner ("BR_ggH"+strSystTitle[f]+Form("_%s_iCat%d_%djet",chan.Data(),iCat, cate_vbf), "ggH"+strSystTitle[f]+"BR", *mreco, *mean, *sigma);
 
  RooAbsPdf* convpdf_spline;
  RooAbsReal* final_integral;
  if (onshell){
    RooFFTConvPdf* convpdf_spline = new RooFFTConvPdf("ggH"+strSystTitle[f]+Form("_%s_iCat%d_%djet",chan.Data(),iCat, cate_vbf), "ggH"+strSystTitle[f],*mzz, *brpdf,dcrReso);
